...
def prune_leaves(t, vals):
    ...
    if is_leaf(t):
      ...
      #be careful with the not None part: branches cannot have the none part, it would cause an assertion error. 
# Mobiles
...
def balanced(m):
    ...
    """
    "*** YOUR CODE HERE ***"
    # You need to check if the rest mobiles are being balanced or not
